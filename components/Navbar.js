  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className={`hidden md:flex items-center justify-between px-6 py-1 text-sm transition-all duration-300 ${
        ...
        <a href="tel:+919068403363" className="flex items-center gap-1 hover:text-white">
          <Phone size={14} /> +91-90684-03363
        </a>
      </div>
        ...
        <div className="md:hidden bg-white border-t border-orange-100 shadow-xl">
          <div className="px-4 py-2 space-y-1">
            ...
            <div className="flex gap-2 pt-3 pb-2">
              <a href="https://wa.me/919068403363" className="flex-1 text-center bg-green-500 text-white py-2 rounded-full text-sm font-medium">WhatsApp</a>
